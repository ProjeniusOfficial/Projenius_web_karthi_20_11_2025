...
import circle from "../img/c2.webm";
import Navbar from "../components/NavBar.tsx";
import roboonline from "../img/robot.png";
...
<section className="interactive-section">
  ...
  <div className="interactive-left slide-in">
    ...
    <button className="join-btn">Join Live Classes</button>
  ...
  <div className="interactive-right">
    ...
    <div className="active-learners-card">
          <img src="https://img.icons8.com/?size=100&id=63320&format=png&color=00fff2" />
      <div>
